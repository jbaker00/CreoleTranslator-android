...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        // Edge-to-edge: lets BannerAd respect gesture nav insets. Must run
        // before super.onCreate so the window is configured before the
        // decor view is created. Replaces the deprecated
        // WindowCompat.setDecorFitsSystemWindows, which Play Console flags
        // on API 35+.
        enableEdgeToEdge()
